<?php
/**
 * Coyote_Image_Descriptions Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_cid_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/coyote-image-descriptions.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_cid_plugin' );
